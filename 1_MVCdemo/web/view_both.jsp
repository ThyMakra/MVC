        ...
        <div class="container-fluid">
            <div class="col-md-6">
                <div class="left-content">
                    ...
                    <p>Nullasdfadfsdfsda vitae interdum libero, vel posuere ipsum. Phasellus interdum est et dapibus tempus. Vestibulum malesuada lorem condimentum mauris ornare dapibus. Curabitur tempor ligula et <a href="#">placerat</a> molestie.</p>
